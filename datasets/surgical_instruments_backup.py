...
class SurgicalInstruments(Dataset):
    ...
    Data structure:
        ...
        parts/<video_id>/<frame>.png    - Part segmentation (1=wrist, 2=shaft, 3=body)
    ...
    def __getitem__(self, idx):
        ...
        for inst_id in inst_ids:
            ...
            wrist_region = inst_binary & (parts_np == 2)  # part 2 = wrist
            ...
            # Per-instrument part labels within the instance mask
            # Raw: 1=gripper, 2=wrist, 3=shaft
            # 0=background, 1=gripper, 2=wrist, 3=shaft
            inst_parts = np.zeros_like(mask_np, dtype=np.int64)
            for part_val, label in [(1, 1), (2, 2), (3, 3)]:
                inst_parts[inst_binary & (parts_np == part_val)] = label
