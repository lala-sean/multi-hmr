...
def main(args):
    ...
    if args.eval_only:
        ...
        train_dataset = ConcatDataset([ds_needle_puncture, ds_needle_grasping, ds_knotting, ds_suture_pulling, ds_endovis17, ds_endovis18])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', type=str, default='instrument_rarp_combined')
    ...
    parser.add_argument('--needle_train_ratio', type=float, default=0.99,
